...
export class StandardService {
  ...
  addStandard(Name: string, DownstreamRate:string, UpstreamRate: string, Splitlimit: string, Reach: string, PowerBudgetMax: string, PowerBudgetMin: string, Link: string ){
    return this.web.post('standards', {Name, DownstreamRate, UpstreamRate, Splitlimit, Reach, PowerBudgetMax, PowerBudgetMin, Link});
