...
export class StandardsComponent implements OnInit {
  ...
  onAdd(Name: string, DownstreamRate:string, UpstreamRate: string, Splitlimit: string, Reach: string, PowerBudgetMax: string, PowerBudgetMin: string, Link: string, DispersionBudget: string){
    ...
    this.StandardService.addStandard(Name, DownstreamRate, UpstreamRate, Splitlimit, Reach, PowerBudgetMax, PowerBudgetMin, Link, DispersionBudget)
